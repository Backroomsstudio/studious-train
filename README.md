...
preventivo in tempo reale e SEO locale per "studio di registrazione Vicenza".
...
| `lib/content.ts` | Servizi, attrezzatura, tracce del portfolio, listino del calcolatore, recensioni, FAQ |
...
4. **Attrezzatura e prezzi**: sostituisci con il gear e il listino reali.
...
app/
  ...
  opengraph-image.tsx twitter-image.tsx apple-icon.tsx icon.svg   immagini generate al build
components/
  ...
  Calculator.tsx        preventivo in tempo reale → WhatsApp / Email / Prenotazione
